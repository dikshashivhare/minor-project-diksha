...
class JobCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_category" do
    assert_difference('JobCategory.count') do
      post job_categories_url, params: { job_category: { description: @job_category.description, icon_url: @job_category.icon_url, name: @job_category.name } }
    end
  ...
  test "should update job_category" do
    patch job_category_url(@job_category), params: { job_category: { description: @job_category.description, icon_url: @job_category.icon_url, name: @job_category.name } }
